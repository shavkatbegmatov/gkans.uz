...
$routes->get('/products/add', 'ProductController::addProduct');
$routes->get('/products/change/', 'ProductController::changeProduct');
$routes->get('/products/product/(:num)', 'ProductController::product/$1');
$routes->get('/shavkat', 'ShavkatController::index');
